...
Notes' disclosure should include the following information about contingencies:
...
-  Litigation: lawsuits, claims, and managerial assessments.
...
A commitment is a potential claim against a company's resources based on past contractual agreements that depends on some future event.
...
2. Treasury stock (buybacks)
    ...
    -  The amount of capital stock repurchased by the company and kept in their own treasury. 
...
1. Capital Increase of \$1,000,000.
