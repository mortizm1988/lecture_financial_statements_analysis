...
Compare b and c regarding their impact on liquidity (current and cash ratio), solvency (debt to assets), profitability (net profit ratio) during the transition from year 4 to year 5. 
...
- Mercedes: Check "Combined Management Report>Refinancing", and Note "Financing liabilities".
...
Mercedes: Note - Equipment in operating leases
...
Now it should be clear why operating leases were so popular: it positively affects key ratios that are used by investors and creditors to assess the financial health of the company.
