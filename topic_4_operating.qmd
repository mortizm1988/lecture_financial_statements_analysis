...
-   The adjustment is straightforward.
    ...
    -   Amounts for assets and liabilities are typically provided in footnotes.
...
This means that all current and prior periods information in the income statement and balance sheet will reflect the effects of the new principle.
...
In both cases (accounting principle and estimate), the analyst must consider that the accounting changes do'nt yield  cash-flow consequences, either present or future.
...
-   today: nearly 50% of the US companies report special items.
-   2% of total revenues.
