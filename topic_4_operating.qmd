...
2) Search: Item 7. Management’s Discussion and Analysis of Financial Condition and Results of Operations --> "Products and Services Performance" and the later subsections.
...
$$ \text{Diluted EPS}= \frac{ 
  \text{Net income - Pref dividends}+\text{Conv pref dividends}+\text{Conv debt interest}*(1-t)}
  {\text{Weighted-average number of common shares outstanding (incl dil securities)}} $$
