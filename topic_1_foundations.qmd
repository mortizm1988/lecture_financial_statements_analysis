...
### Transactions as accounting events
...
1.  Identify the contract with the customer: clear allocation of rights, obligations and payment terms.
...
3.  Determine the transaction price:
    ...
    -   the company recognize revenue can recognize only highly likely payments.
...
Silvana eTravel SA Let's apply the accounting equation and matching principle to the following transactions:

------------------------------------------------------------------------

**Transaction 1: Starting the business** Silvana invested \$30,000 of her own money to start the business. ​

She deposits \$30,000 in a "Silvana eTravel SA" bank account.

------------------------------------------------------------------------

**Transaction 2: Buying an office** Silvana purchases an office, paying \$20,000 in cash. ​

Montly Depreciation: \$200​

------------------------------------------------------------------------

**Transaction 3: Buying an office supplies** Silvana buys office supplies, agreeing to pay \$500 within 30 days.​
...
It provides insights about company situation in terms of: - liquidity - solvency - ability to make distributions to shareholders

------------------------------------------------------------------------

## Statement of Comprehensive Income

![](topic_1_img/img_5.png)
...
### Dependencies in Financial Statements
