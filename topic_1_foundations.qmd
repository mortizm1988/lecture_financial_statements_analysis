...
Silvana borrows \$5.000 using a Long term bank credit (3 years). The first month generates \$35 on interest expenses.
...
|-----------------------------------|------------------------------------------------|
| 1\. Cash and cash equivalents     | 1\. Financial assets at amortized cost / FVOCI / FVTPL |
...
1.  **Present value (PV) of future payments**: loans, bonds, and lease obligations are valued at the present value of future payments. This valuation takes into account the time value of money.
2.  **Expected PV**: uncertainty of provisions and contingent liabilities.
3.  **Fair Value**: financial liabilities like derivative contracts or financial instruments are measured at fair value. 

Equity valuation

1.  **Historical Cost**: Share capital and retained earnings based on their historical value at origination.
2.  **Revaluation Reserves**: Equity is adjusted to reflect fair value adjustment in non-financial assets.
3.  **Fair Value through OCI**: Some equity instruments not held for trading can be valued at fair value through other comprehensive income.

------------------------------------------------------------------------

### 3.2 Financial Statements: Why?
...
2. **Common Stock**: + capital increase; - capital decrease
