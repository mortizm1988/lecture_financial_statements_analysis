...
- what happen with the production costs when production increases?ˇ
...
Capitalization: the cost of an asset is recorded as an asset rather than as an expense.
...
What is the carrying amount in the Balance Sheet of the machine after two years if the company uses the **straight-line method**?\
...
b)  Indefinite useful life: no amortization
    ...
    -   Impairment test at least annually (IAS 36, as discussed before).
...
-   **Goodwill** is the amount by which the purchase price exceeds the **fair value** of the acquired company’s identifiable net assets.
    -   It represents off-balance-sheet **intangible assets** such as brand reputation, customer relationships, social capital that are not separately identifiable.
    -   **IFRS 3** requires goodwill to be recognized as an asset on the balance sheet of the acquiring company.
...
**Consolidation requirement**: the acquiring company must consolidate the financial statements of the acquired company to present a unified view of the group.
...
-   Report the remaining 20% as non-controlling interest in the equity section, representing the portion of equity owned by other shareholders in "Child Ltd".

------------------------------------------------------------------------

Example Consolidation

-   Mercedes Benz: Note "Information on investments"

Questions:

- How is the group structured?
- Where the subsidiaries and joint ventures are located?
- What information is disclosed for each of them?
