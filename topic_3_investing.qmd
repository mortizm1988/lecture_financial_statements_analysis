...
::: callout-note
The impacts are not the same if the company is expanding or renovating its PPE.
...
Example (Under IFRS)
The manager of Barceloneta Inc has collected the following information about a set of assets tested for impairment:
...
A company reported at the begining of the year a Trademark with a carrying value of $1,000,000 and it has an indefinite useful life. 
