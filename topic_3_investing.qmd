...
Assume that the following table reflects the inventory records of a company:
...
Important: LIFO is not allowed in IFRS! Why? Mainly because it delays or reduces the payment of taxes. 
...
Allocation is not a valuation process. It is a way to match the cost of an asset with the revenues it generates!!
...
In sum, investing in fixed tangible assets will have three impacts on the financial statements:
...
3) Operating Cash flows: When asset costs are capitalized, they are reported as _investing_ cash outflows. (In contrast, if they were expensed, they are reported as _operating_ cash outflows).
...
### 6.1 Accounting for Acquisitions 

 IFRS 3 requires the **acquisition method** for all **business combinations**.

  - **Step 1**: Identify the acquiring company.
  - **Step 2**: Measure the **consideration transferred** (the total purchase price, including cash, shares, or other forms of payment).
  - **Step 3**: Identify and measure **acquired assets** and **liabilities** at their fair value.
  - **Step 4**: Recognize any **goodwill** or gain from a bargain purchase (price - net asset acquired).

- **Consideration**: Could be cash, equity shares, or a combination of both. This must be measured at fair value on the acquisition date.

-  costs related to the acquisition, such as legal fees, are expensed as incurred, and not included in the purchase price. 

---

IFRS 10: Consolidated Financial Statements

- After an acquisition, the acquiring company must **consolidate** the financial statements of the acquired company.
  - **Control** is established when the acquiring company has power over the acquired entity and the ability to influence its returns.
  - Consolidation involves **combining** the assets, liabilities, revenue, and expenses of the acquired company into the financial statements of the acquirer.
  - Adjustments are made for **non-controlling interests** if the acquirer doesn't own 100% of the acquired company.

Example:
- If Company X acquires 80% of Company Y, it consolidates 100% of Y's assets and liabilities but adjusts for the 20% **non-controlling interest**.
...
- Identifiable net assets of Company Y:
  - Cash: $50,000
  - Property: $500,000
  - Equipment: $200,000
  - Liabilities: ($100,000)
  - **Net assets**: $650,000
- Goodwill calculation: Purchase price - net assets = $1,000,000 - $650,000 = $350,000 of goodwill.

---

**How Does This Appear in the Financial Statements?**

a) Company X's Balance Sheet:
  - The **assets** of Company Y (cash, property, etc.) on its consolidated balance sheet.
    - The **goodwill** of $350,000 as an asset.
  - The **liabilities** of Company Y.
b) Company X's Income Statement:
  - Acquisition-related expenses (e.g., legal fees) are reported.
  - Goodwill impairment tests may reduce profits.
c) Company X's Cash Flow Statement:
