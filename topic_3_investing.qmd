...
Impairment: is the write-down of an long-term asset to its fair value when its carrying value ("Net PPE") exceeds its recoverable amount. [IFRS IAS 36](https://www.ifrs.org/issued-standards/list-of-standards/ias-36-impairment-of-assets/).
