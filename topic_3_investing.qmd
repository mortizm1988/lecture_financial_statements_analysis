...
2) Search: Note 4 - Financial Instruments -> "Cash, Cash Equivalents,..."
...
3) Mercedez: Note 19 - Trade Receivables; Note 33 --> "Receivables from financial services"

- How much are the net receivables?
- What type of receivables are reported?
- How much is the "allowance for doubtful accounts"/"loss allowances" or bad debt expense?
...
- Hard assets, such as PPE: assets recorded at cost (purchase price + all costs necessary to get the asset ready for use) and allocated ("expensed") over their useful life.

Cost allocation: is the assignment of the cost of an asset as an expense over its useful life.
...
Investing in fixed tangible assets has three impacts on the financial statements:
...
Impairment: is the write-down of an asset to its fair value when its carrying value ("Net PPE") exceeds its fair value. [IFRS IAS 36](https://www.ifrs.org/issued-standards/list-of-standards/ias-36-impairment-of-assets/).
...
-  The costs related to the acquisition, such as legal fees, are expensed as incurred, and not included in the purchase price. 
...
- Identifiable net assets of Company "Child Ltd":
  - Cash: $50,000
  - Property: $500,000
  - Equipment: $200,000
  - Liabilities: ($100,000)
